...
tower-cli job_template create --name="Webserver1-Maintenance" --description="Webserver1 Maintenance" --inventory="F5-Demo-Inventory" --project="F5-Demo" --playbook="${BASE_DIR}/host1_maintenance.yml"
